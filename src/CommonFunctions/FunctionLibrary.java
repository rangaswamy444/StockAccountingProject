...
public class FunctionLibrary {
	...
	public static WebDriver startBrowser() throws Throwable
	{
		...
		else if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("firefox"))
		{
			...
			System.setProperty("webdriver.gecko.driver", "C:\\Selenium_OJT\\ERP_StockAccounting\\CommonDrivers\\geckodriver.exe");
	...
	public static void captureData(WebDriver driver,String Locatortype,String Locatorvalue) throws Throwable
	{
		...
		//write into notepad
		FileWriter fw = new FileWriter("C:\\Selenium_OJT\\ERP_StockAccounting\\CaptureData\\suppliernum.txt");
	...
	public static void tableValidation(WebDriver driver,String ColNum) throws Throwable
	{
		...
		FileReader fr = new FileReader("C:\\Selenium_OJT\\ERP_StockAccounting\\CaptureData\\suppliernum.txt");
